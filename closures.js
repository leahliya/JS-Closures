...
var counterFactory = function(val) {
var count = val;
  return {
    inc: function(){
      count++;
...
motivation('Brian', 'Kemper'); // 'You're doing awesome keep it up Billy Bob.
...
function findPotentialFriends(existingFriends) {
 ...
 return function(name){
         if (existingFriends.includes(name))return false;
         else return true;
     };
   }
...
from allUsers. */
 ...
 // var potentialSecondLevelFriends = function (name){
 //	secondLevelFriends.filter(function(element){
 //  return findPotentialFriends(element);
 //});
//var potentialSecondLevelFriends = "?";
//var potentialSecondLevelFriends=findPotentialFriends(secondLevelFriends );
